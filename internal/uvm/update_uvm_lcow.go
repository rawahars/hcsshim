...
// updateLCOW handles resource updates specific to Linux UVMs (LCOW).
// data should be of type *specs.LinuxResources or *ctrdtaskapi.PolicyFragment.
func (uvm *UtilityVM) updateLCOW(ctx context.Context, data interface{}, annots map[string]string) error {
