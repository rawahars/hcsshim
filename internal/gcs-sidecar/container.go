...
func (c *Container) CreateProcess(
	...
	stdioConfig *prot.ExecuteProcessStdioRelaySettings,
) (cow.Process, error) {
...
func (c *Container) GetProperties(ctx context.Context, types ...hcsschema.PropertyType) (*hcsschema.Properties, error) {
	return c.container.PropertiesV2(ctx, types...)
}
