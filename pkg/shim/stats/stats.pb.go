...
// 	protoc        v5.26.0
// source: github.com/Microsoft/hcsshim/pkg/shim/stats/stats.proto
...
func (x *Statistics) Reset() {
	*x = Statistics{}
	mi := &file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[0]
...
func (*Statistics) Descriptor() ([]byte, []int) {
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP(), []int{0}
}
...
func (x *WindowsContainerStatistics) Reset() {
	*x = WindowsContainerStatistics{}
	mi := &file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WindowsContainerStatistics) Descriptor() ([]byte, []int) {
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP(), []int{1}
}
...
func (x *WindowsContainerProcessorStatistics) Reset() {
	*x = WindowsContainerProcessorStatistics{}
	mi := &file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WindowsContainerProcessorStatistics) Descriptor() ([]byte, []int) {
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP(), []int{2}
}
...
func (x *WindowsContainerMemoryStatistics) Reset() {
	*x = WindowsContainerMemoryStatistics{}
	mi := &file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WindowsContainerMemoryStatistics) Descriptor() ([]byte, []int) {
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP(), []int{3}
}
...
func (x *WindowsContainerStorageStatistics) Reset() {
	*x = WindowsContainerStorageStatistics{}
	mi := &file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WindowsContainerStorageStatistics) Descriptor() ([]byte, []int) {
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP(), []int{4}
}
...
func (x *VirtualMachineStatistics) Reset() {
	*x = VirtualMachineStatistics{}
	mi := &file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VirtualMachineStatistics) Descriptor() ([]byte, []int) {
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP(), []int{5}
}
...
func (x *VirtualMachineProcessorStatistics) Reset() {
	*x = VirtualMachineProcessorStatistics{}
	mi := &file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VirtualMachineProcessorStatistics) Descriptor() ([]byte, []int) {
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP(), []int{6}
}
...
func (x *VirtualMachineMemoryStatistics) Reset() {
	*x = VirtualMachineMemoryStatistics{}
	mi := &file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VirtualMachineMemoryStatistics) Descriptor() ([]byte, []int) {
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP(), []int{7}
}
...
func (x *VirtualMachineMemory) Reset() {
	*x = VirtualMachineMemory{}
	mi := &file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VirtualMachineMemory) Descriptor() ([]byte, []int) {
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP(), []int{8}
}
...
var File_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto protoreflect.FileDescriptor

const file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDesc = "" +
	"\n" +
	"7github.com/Microsoft/hcsshim/pkg/shim/stats/stats.proto\x12\x1acontainerd.runhcs.stats.v2\x1a\x1fgoogle/protobuf/timestamp.proto\x1a<github.com/containerd/cgroups/v3/cgroup1/stats/metrics.proto\"\xee\x01\n" +
	"\n" +
	"Statistics\x12R\n" +
	"\awindows\x18\x01 \x01(\v26.containerd.runhcs.stats.v2.WindowsContainerStatisticsH\x00R\awindows\x129\n" +
	"\x05linux\x18\x02 \x01(\v2!.io.containerd.cgroups.v1.MetricsH\x00R\x05linux\x12D\n" +
	"\x02vm\x18\x03 \x01(\v24.containerd.runhcs.stats.v2.VirtualMachineStatisticsR\x02vmB\v\n" +
	"\tcontainer\"\xcf\x03\n" +
	...
	"\tprocessor\x18\x04 \x01(\v2?.containerd.runhcs.stats.v2.WindowsContainerProcessorStatisticsR\tprocessor\x12T\n" +
	"\x06memory\x18\x05 \x01(\v2<.containerd.runhcs.stats.v2.WindowsContainerMemoryStatisticsR\x06memory\x12W\n" +
	"\astorage\x18\x06 \x01(\v2=.containerd.runhcs.stats.v2.WindowsContainerStorageStatisticsR\astorage\"\xa3\x01\n" +
	...
	"\tprocessor\x18\x01 \x01(\v2=.containerd.runhcs.stats.v2.VirtualMachineProcessorStatisticsR\tprocessor\x12R\n" +
	"\x06memory\x18\x02 \x01(\v2:.containerd.runhcs.stats.v2.VirtualMachineMemoryStatisticsR\x06memory\"M\n" +
	...
	"\tvm_memory\x18\x03 \x01(\v20.containerd.runhcs.stats.v2.VirtualMachineMemoryR\bvmMemory\"\xd0\x02\n" +
	...
	"\x18dm_operation_in_progress\x18\a \x01(\bR\x15dmOperationInProgressB3Z1github.com/Microsoft/hcsshim/pkg/shim/stats;statsb\x06proto3"

var (
	file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescOnce sync.Once
	file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescData []byte
)

func file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescGZIP() []byte {
	file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescOnce.Do(func() {
		file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDesc), len(file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDesc)))
	})
	return file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDescData
}

var file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_goTypes = []any{
	(*Statistics)(nil),                          // 0: containerd.runhcs.stats.v2.Statistics
	(*WindowsContainerStatistics)(nil),          // 1: containerd.runhcs.stats.v2.WindowsContainerStatistics
	(*WindowsContainerProcessorStatistics)(nil), // 2: containerd.runhcs.stats.v2.WindowsContainerProcessorStatistics
	(*WindowsContainerMemoryStatistics)(nil),    // 3: containerd.runhcs.stats.v2.WindowsContainerMemoryStatistics
	(*WindowsContainerStorageStatistics)(nil),   // 4: containerd.runhcs.stats.v2.WindowsContainerStorageStatistics
	(*VirtualMachineStatistics)(nil),            // 5: containerd.runhcs.stats.v2.VirtualMachineStatistics
	(*VirtualMachineProcessorStatistics)(nil),   // 6: containerd.runhcs.stats.v2.VirtualMachineProcessorStatistics
	(*VirtualMachineMemoryStatistics)(nil),      // 7: containerd.runhcs.stats.v2.VirtualMachineMemoryStatistics
	(*VirtualMachineMemory)(nil),                // 8: containerd.runhcs.stats.v2.VirtualMachineMemory
	(*stats.Metrics)(nil),                       // 9: io.containerd.cgroups.v1.Metrics
	(*timestamppb.Timestamp)(nil),               // 10: google.protobuf.Timestamp
}
var file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_depIdxs = []int32{
	1,  // 0: containerd.runhcs.stats.v2.Statistics.windows:type_name -> containerd.runhcs.stats.v2.WindowsContainerStatistics
	9,  // 1: containerd.runhcs.stats.v2.Statistics.linux:type_name -> io.containerd.cgroups.v1.Metrics
	5,  // 2: containerd.runhcs.stats.v2.Statistics.vm:type_name -> containerd.runhcs.stats.v2.VirtualMachineStatistics
	10, // 3: containerd.runhcs.stats.v2.WindowsContainerStatistics.timestamp:type_name -> google.protobuf.Timestamp
	10, // 4: containerd.runhcs.stats.v2.WindowsContainerStatistics.container_start_time:type_name -> google.protobuf.Timestamp
	2,  // 5: containerd.runhcs.stats.v2.WindowsContainerStatistics.processor:type_name -> containerd.runhcs.stats.v2.WindowsContainerProcessorStatistics
	3,  // 6: containerd.runhcs.stats.v2.WindowsContainerStatistics.memory:type_name -> containerd.runhcs.stats.v2.WindowsContainerMemoryStatistics
	4,  // 7: containerd.runhcs.stats.v2.WindowsContainerStatistics.storage:type_name -> containerd.runhcs.stats.v2.WindowsContainerStorageStatistics
	6,  // 8: containerd.runhcs.stats.v2.VirtualMachineStatistics.processor:type_name -> containerd.runhcs.stats.v2.VirtualMachineProcessorStatistics
	7,  // 9: containerd.runhcs.stats.v2.VirtualMachineStatistics.memory:type_name -> containerd.runhcs.stats.v2.VirtualMachineMemoryStatistics
	8,  // 10: containerd.runhcs.stats.v2.VirtualMachineMemoryStatistics.vm_memory:type_name -> containerd.runhcs.stats.v2.VirtualMachineMemory
...
func init() { file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_init() }
func file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_init() {
	if File_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto != nil {
		return
	}
	file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDesc), len(file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_goTypes,
		DependencyIndexes: file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_depIdxs,
		MessageInfos:      file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_msgTypes,
	}.Build()
	File_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto = out.File
	file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_goTypes = nil
	file_github_com_Microsoft_hcsshim_pkg_shim_stats_stats_proto_depIdxs = nil
}
